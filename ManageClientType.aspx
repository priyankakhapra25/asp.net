<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageClientType.aspx.cs" Inherits="CRMSystem.ManageClientType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card profile-card card-bx m-b30">
                            <div class="card-header">
                                ...
                                <h5 class="title">Client Type List</h5>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 class="modal-title">Manage Client Type</h6>
    ...
    <script src="js/Ajax/ManageClientType.js"></script>
