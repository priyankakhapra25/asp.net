<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageMessageHeader.aspx.cs" Inherits="CRMSystem.ManageMessageHeader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-12">
                        <div class="col-12 ">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="title">Message Header</h5>
                            </div>
                           <div class="mb-3 p-5">
    ...
    <script src="js/Ajax/ManageMessageHeader.js"></script>
