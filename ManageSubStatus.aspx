<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageSubStatus.aspx.cs" Inherits="CRMSystem.ManageSubStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card profile-card card-bx m-b30">
                            <div class="card-header">
                                ...
                                <h5 class="title">SubStatus List</h5>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 class="modal-title">Manage SubStatus</h6>
                    ...
                    <div class="modal-body">                        
                        <div class="row">
                               <div class="col-sm-12 my-2">
                                    <label class="form-label">Sub Status<span style="color: red">*</span></label>
    ...
    <script src="js/Ajax/ManageSubStatus.js"></script>
