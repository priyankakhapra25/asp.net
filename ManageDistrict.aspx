<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageDistrict.aspx.cs" Inherits="CRMSystem.ManageDistrict" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card profile-card card-bx m-b30">
                            <div class="card-header">
                                ...
                                <h5 class="title">District List</h5>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 class="modal-title">Manage District</h6>
                    ...
                    <div class="modal-body">                        
                        <div class="row">
                            <div class="col-6 my-2">
                                    ...
                                    <select id="txtState" class="form-control validated" data-label="state"> </select>
    ...
    <script src="js/Ajax/ManageDistrict.js"></script>
