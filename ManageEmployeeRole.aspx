<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageEmployeeRole.aspx.cs" Inherits="CRMSystem.ManageEmployeeRole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card profile-card card-bx m-b30">
                            <div class="card-header">
                                ...
                                <h5 class="title">Employee Role List</h5>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 class="modal-title">Manage Employee Role</h6>
                    ...
                    <div class="modal-body">                        
                        <div class="row">
                               <div class="col-sm-12 my-2">
                                    ...
                                    <input type="text" class="form-control validated" id="txtRole" data-label="Role" />                                          
    ...
    <script src="js/Ajax/ManageEmployeeRole.js"></script>
